...
cb.LineWidth = 1; 
    ...
    text(x0 - 0.025*range(xlim), y0-h/1.95, '$\cdot\cdot \ p \in\mathcal{Z}$ ', ...
        'FontSize',23,'FontName','Times New Roman', ...
        'FontWeight','normal','Interpreter','latex', ...
        'HorizontalAlignment','left','VerticalAlignment','middle');
...
elseif iplot == 3
    ...
    %v = 12:1:24
    contourf(char_freq.Pzeta_norm,char_freq.lambda,l_res,100,'edgecolor','none');cb=colorbar('northoutside');colormap('jet');hold on;caxis([v(1) v(end)])
    %title('l\_res\_d');
    cb.FontSize = 15;
        cb.Label.FontName = 'Times New Roman';
cb.FontWeight = 'bold';          
